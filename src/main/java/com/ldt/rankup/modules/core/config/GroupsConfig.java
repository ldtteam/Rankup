package com.ldt.rankup.modules.core.config;
...
public class GroupsConfig extends BaseConfig
{
    ...
    public static class GroupConfig
    {
        ...
        @Setting(value = "group-rank", comment = "The rank of which the group is, rank zero is a starting rank of a player, rank one being the next rank they will gain. Set to -1 to ignore")
        public int rank = 0;
