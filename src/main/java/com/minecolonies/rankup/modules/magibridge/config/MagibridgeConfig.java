...
public class MagibridgeConfig
{
    ...
    @Setting(value = "rankup-Message", comment = "Message to discord when a player ranks up! \n valid entries: " + Constants.PlayerInfo.PLAYER_NAME + ", " + Constants.ModuleInfo.MAGIBRIDGE_NEXT + " and " + Constants.ModuleInfo.MAGIBRIDGE_CURR + "")
    public String rankupMessage = "Player " + Constants.PlayerInfo.PLAYER_NAME + " has left the " + Constants.ModuleInfo.MAGIBRIDGE_CURR + " group and joined the " + Constants.ModuleInfo.MAGIBRIDGE_NEXT + " group! :smile:";
